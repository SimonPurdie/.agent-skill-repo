...
## Developing HBOX Native Applications

A native HBOX application is a local web application whose launch and lifecycle are integrated with HBOX. This does not necessarily apply to any project or folder added to HBOX. When developing an HBOX native app, you should use STANDARD_FEATURES.md as a reference to the standard features that a native app should include.
